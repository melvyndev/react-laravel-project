import React, { Fragment } from 'react'; // Importer Fragment depuis react
import { Disclosure, Menu, Transition } from '@headlessui/react';
import { Bars3Icon, BellIcon, XMarkIcon } from '@heroicons/react/outline'; // Correction du chemin pour les icônes
import { NavLink, Outlet } from 'react-router-dom';
import { useUserStateContext } from '../contexts/ContextProvider';
import { UserCircleIcon } from '@heroicons/react/solid'; // Correction du chemin pour l'icône UserCircleIcon
...
const DefaultLayout: React.FC = () => {
  const { currentUser } = useUserStateContext(); // Utiliser currentUser depuis le contexte
